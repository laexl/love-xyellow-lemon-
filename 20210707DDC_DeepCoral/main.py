...
def train(source_loader, target_train_loader, target_test_loader, model, optimizer, CFG):
    ...
    for e in range(CFG['epoch']):
        ...
        print('这是历史最佳准确率{} --> {}: max correct: {}, accuracy{: .2f}%\n'.format(source_name, target_name, best_correct, 100. * best_correct / len_target_dataset))
...
if __name__ == '__main__':
    ...
    source_name       = "FE_6203_3HP/train"
    target_name       = "FE_6203_1HP/val"
