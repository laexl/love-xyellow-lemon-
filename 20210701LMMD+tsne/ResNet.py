...
class DSAN(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        self.feature_layers = resnet50(False)
...
def resnet50(pretrained=False, **kwargs):
    ...
    """
    # resnet50这个方法实际上时调用的ResNet。
	# Bottleneck在Config.py中定义，是ResNet中的瓶颈层，用来大幅度减少计算量。
