...
src_name      = "FE_6203_1HP/train"
tgt_name      = "FE_6203_023HP/val"
tgt_test_name = "FE_6203_023HP/test"
...
tgt_test_loader = data_loader.load_testing(root_path, tgt_test_name, batch_size, kwargs)
    ...
    for i in range(1, iteration+1):
        ...
        if i%(log_interval*10)==0:
            ...
            print('src: {} to tgt: {} max correct: {} max accuracy{: .2f}%\n'.format(
              src_name, tgt_test_name, correct, 100. * correct / tgt_dataset_len ))
...
def test(model):
    ...
    print('\n{} set: Average loss: {:.4f}, Accuracy: {}/{} ({:.2f}%)\n'.format(
        tgt_test_name, test_loss, correct, tgt_dataset_len,
