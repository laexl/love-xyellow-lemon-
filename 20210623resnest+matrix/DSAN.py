...
all_classes_type = ['N', 'IR07', 'IR14', 'IR21', 'B07', 'B14', 'B21', 'OR07', 'OR14', 'OR21']
...
def test(model):
    ...
    with torch.no_grad():
        ...
        for data, target in target_test_loader:
            ...
            # 在之前计算的混淆矩阵的基础上，计算这一批次的混淆矩阵。
            conf_matrix = confusion_matrix(pred, target, conf_matrix)  # pred是预测的目标域样本标签，target是实际的目标域样本标签
        # 计算得到平均损失
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        t_correct,test_loss, t_conf_matrix = test(model)
    ...
    plot_confusion_matrix(conf_matrix.numpy(), classes=all_classes_type, normalize=False, title='混淆矩阵')
